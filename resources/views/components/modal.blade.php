...
<div x-data="{
    ...
    class="fixed inset-0 overflow-y-auto   sm:px-0 z-50" style="display: {{ $show ? 'block' : 'none' }};">
    ...
    <div x-show="show"
        ...
        x-transition:leave-start="opacity-100 translate-y-10 sm:scale-100"
        x-transition:leave-end="opacity-0 translate-y-30 sm:translate-y-0 sm:scale-95">
        {{ $slot }}
    </div>
</div>
