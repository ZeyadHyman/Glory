<div x-data="{ openEditModal: false, editItemId: null, open: false, confirmDeleteId: null }">
    @if ($activeTab == 'products')
        <div class="pb-4 flex justify-between">
            <form wire:submit.prevent='handleSearching' class="flex flex-col sm:flex-row items-start sm:items-center">
                ...
                <div class="relative w-full sm:w-auto">
                    <input type="text" id="table-search" wire:model.live="search"
                        class="block w-full pt-2 ps-10 text-sm text-white border border-gray-600 rounded-lg sm:w-80 bg-gray-700 focus:ring-cyan-500 focus:border-cyan-500 placeholder-gray-400"
            ...
            <button
                class="px-8 py-3 transition-all duration-300 bg-[#1f815b] hover:bg-[#1f815bd5] border border-transparent hover:border-white/50 rounded-xl text-zinc-50 flex items-center justify-center gap-2 focus:outline-none focus:ring-2 focus:ring-[#0b1d2c] focus:ring-opacity-50">
                Add New Product
            </button>
        </div>
