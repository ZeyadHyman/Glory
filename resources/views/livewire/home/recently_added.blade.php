<div class="bg-[#13212E]  md:rounded-xl mt-5 p-5">
    ...
    <section class="splide splide-splide mt-2" aria-labelledby="carousel-heading">
        <div class="splide__track">
            <ul class="splide__list">
                <li class="splide__slide mr-5 text-center text-zinc-50 place-content-center ">
                    <div class="relative h-full">
                        <img src={{ 'https://images.pexels.com/photos/20827831/pexels-photo-20827831/free-photo-of-person-fingers-holding-dandelion-on-meadow.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' }}
                            alt="test" class="rounded-xl h-full w-full object-cover ">
                        <div
