...
<div class="bg-[#13212E] md:rounded-xl mt-5 p-5">
    ...
    <div class=" grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 w-full h-full hidden lg:grid">
        <div
        ...
        <div
            ...
            <div
                class="absolute inset-0 bg-black/70 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <h1 class="text-zinc-50 text-xl font-bold">Test</h1>
            </div>
        </div>
    </div>

    {{-- Mobile Version --}}
    <section class="splide splide-category w-full h-full mt-2 block lg:hidden" aria-labelledby="carousel-heading">
